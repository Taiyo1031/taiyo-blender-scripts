...
- GitHubを開くボタン
- JSON Export
- Search時の一致ノードへの自動フォーカス
- Macトラックパッド向けの2本指パン、ピンチ / Cmdスクロールズーム
- キーボードだけでの検索、結果移動、パン、ズーム、Fit View
- 左右サイドバー位置の入れ替え
- 画面下部の小さな使用方法とショートカット表示
- 検索
- Node Typeの色凡例
- ノードクリック時の詳細表示
...
- Safe Delete Previewは現在のグラフスキャン範囲内の参照をもとにした確認用プレビューです。実際の削除は行いません。
